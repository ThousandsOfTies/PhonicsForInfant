                    ...
                    cols: [
                        ...
                        },
                        {
                            ...
                            table: {
                                ...
                                chars: [
                                    { text: "all", words: "ball" },
                                    { text: "ild", words: "child" },
                                    { text: "ind", words: "kind blind find" },
                        ...
                        },
                        {
                            ...
                            table: {
                                ...
                                chars: [
                                    ...
                                    { text: "br", words: "branch breath library" },
                                    { text: "sn", words: "snail snow" },
                                    { text: "pl", words: "plane plant" },
                                    { text: "fr", words: "France fruits refrigerator" },
                        ...
                        },
                        {
                            ...
                            table: {
                                ...
                                chars: [
                                    ...
                                    { text: "ch", words: "cherry children chihiro" },
                                    { text: "ph", words: "phone alphabet" },
                                    { text: "wh", words: "whale wheel" },
                                    { text: "th", words: "thunder bath birthday" },
                    ...
                    cols: [
                        ...
                        },
                        {
                            ...
                            table:
                            {
                                ...
                                groups: ["v", "c2"],
                                chars: [
                                    { text: "a-e", words: "cake spade scale ex:have" },
                                    { text: "e-e", words: "Japanese" },
                                    { text: "i-e", words: "cider knife hike ex:give" },
                                    { text: "o-e", words: "globe explode" },
                        ...
                        },
                        {
                            ...
                            table: {
                                ...
                                chars: [
                                    ...
                                    { text: "ay", words: "today crayfish" },
                                    { text: "ea", words: "bean leaf eagle ex:head ex:bread" },
                                    ...
                                    { text: "ue", words: "glue tissue" },
                                    { text: "ui", words: "fruits juice" },
                                ]
                            }
                        },
                        {
                            ...
                            table: {
                                ...
                                groups: ["v", "c4"],
                                chars: [
                                    { text: "oo", words: "zoo book" },
                                    { text: "ou", words: "mouth cloud house ex:young ex:country ex:touch mouse" },
                        ...
                        },
                        {
                            ...
                            table: {
                                ...
                                chars: [
                                    ...
                                    { text: "air", words: "chair" },
                                    { text: "ear", words: "ear bear" },
                                    { text: "wor", words: "firework" },
                                ]
                            }
                        }
                    ]
